...
class UltravoxToolsManager {
  ...
  generateSystemPrompt(enabledTools, customInstructions = '') {
    ...
    # If the client asks about the weather, use the weather tool to get the current weather conditions for their location. If the location is not known, ask for it.
  ...
  getUltravoxConfig(enabledTools, customInstructions = '', voice = null) {
    ...
    const voiceName = voice || ultravoxCredentials.voice || this.voice;
